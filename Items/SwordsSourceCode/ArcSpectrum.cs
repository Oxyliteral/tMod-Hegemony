...
{
	public class ArcSpectrum : ModItem
	{
		...
		{	
			...
			Item.damage = 20;
			Item.knockBack = 1f;
			Item.shoot = ModContent.ProjectileType<ArcSpectrumProjectile>();
			Item.shootSpeed = 0f;
		...
		public override void AddRecipes() {
			...
			recipe.AddIngredient(ItemID.Apple);
			...
			recipe.AddIngredient(ItemID.FlinxFur);
